...
.. code:: rst
  ...
  .. |TRAVIS| image:: https://travis-ci.com/IsobelMarguarethe/pycentricity.svg?token=rMJppszzMSCeZELig3mB&branch=master
    :alt: Travis Badge
    :target: https://travis-ci.com/IsobelMarguarethe/pycentricity
